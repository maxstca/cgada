...
entries3 <- read_in_data(fileName = "v0_14_1_d03_15_2026.csv", playtestDate = "01/25/2026", playtestVersion = "0.14.*", hasHeaders = TRUE)

#Merge obs. into one set of data
dflist <- list(entries1, entries2, entries3)
